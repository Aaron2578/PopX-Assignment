        ...
        <div className="flex h-screen items-center justify-center bg-white">
            <div className="relative flex h-[812px] w-[375px] flex-col rounded-lg border-gray-600 bg-[#F7F8F9] shadow-sm p-6">
                <div className="flex flex-col items-start justify-end h-full w-full">
                    <div>
                    <h1 className="text-[28px] font-medium leading-[17px] text-[#1D2226] mb-4">
                        Welcome to PopX
                    </h1>
                    <p className='mb-7 text-[#1D2226] font-normal text-[18px] leading-[26px] opacity-50'>Lorem, ipsum dolor sit amet, consectetur adipisicing elit,</p>
                    <div>
                        <Link to="/signup">
